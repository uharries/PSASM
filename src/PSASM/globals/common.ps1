...
$PSASMFunctions = (".ascii", ".hi", ".lab", ".lo", ".mac", ".petscii", ".rep", ".txt", "dc.b", "dc.w", ".align", ".byte", ".fill", ".include", ".includeonce", ".inst", ".label", ".macro", ".namespace", ".org", ".pc", ".popsegment", ".pushsegment", ".repeat", ".segment", ".text", ".word", "_getSymbol", "_hiByte", "_invokeMacro", "_loByte")
