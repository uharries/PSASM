...
$PASMFunctions = (".ascii", ".hi", ".lab", ".lo", ".mac", ".petscii", ".rep", ".txt", "dc.b", "dc.w", ".byte", ".fill", ".include", ".includeonce", ".inst", ".label", ".macro", ".org", ".pc", ".repeat", ".text", ".word", "_getSymbol", "_hiByte", "_invokeMacro", "_loByte")
