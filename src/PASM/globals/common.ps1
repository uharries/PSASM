...
$PASMFunctions = (".ascii", ".hi", ".inc", ".lab", ".lo", ".mac", ".petscii", ".rep", ".txt", "dc.b", "dc.w", ".byte", ".fill", ".include", ".inst", ".label", ".macro", ".org", ".pc", ".repeat", ".text", ".word", "_getSymbol", "_hiByte", "_invokeMacro", "_loByte")
